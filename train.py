from dataset import M2SDF_Dataset
from torch.utils.data import DataLoader
import os
from utils.network.unet_dc import UNet
from utils.trainM2SDF import train_M2SDF
import torch
import time
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description='Train modified U-Net with the ImageNet validation set (50000 images) under M2SDF strategy.',
    ...
    parser.add_argument("--datadir", default="SCTD_noisy",
    ...
    model_name_prefix = "OPD-{}_SONARIMAGES".format(args.strategy)
    ...
    total_trainData = M2SDF_Dataset(root_dir=args.dataroot,
    ...
    best_epoch = 0
    model, best_epoch = train_M2SDF(dataloaders=dataloaders, model=model,
