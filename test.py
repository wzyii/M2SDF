...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description='Test the model trained under M2SDF strategy.',
    ...
    parser.add_argument("--srcpath", default="SCTD",
                        help="The directory of the testing data")
    parser.add_argument("--tarpath", default="SCTD",
    ...
    parser.add_argument("--testdata", default="SCTD")
